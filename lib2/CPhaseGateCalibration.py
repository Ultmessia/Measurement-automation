...
class CPhaseGateCalibration2D(VNATimeResolvedDispersiveMeasurement2D):

    def __init__(self, name, sample_name, **devs_aliases_map):
        super().__init__(name, sample_name, devs_aliases_map)
        self._measurement_result = CPhaseGateCalibration2DResult(name, sample_name)
    ...
    def set_swept_parameters(self, z_pulse_offset_voltages, interaction_durations):
        swept_pars = {"z_pulse_offset_voltage":
                          (self._set_z_pulse_offset_voltage, z_pulse_offset_voltages),
                      "interaction_duration":
                          (self._set_interaction_duration_and_output, interaction_durations)}
...
class CPhaseGateCalibration2DResult(VNATimeResolvedDispersiveMeasurement2DResult):
